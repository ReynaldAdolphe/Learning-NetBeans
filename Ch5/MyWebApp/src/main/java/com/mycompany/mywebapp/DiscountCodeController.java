...
import com.mycompany.mywebapp.util.JsfUtil;
import com.mycompany.mywebapp.util.JsfUtil.PersistAction;
...
public class DiscountCodeController implements Serializable {
    ...
    @EJB
    private com.mycompany.mywebapp.DiscountCodeFacade ejbFacade;
